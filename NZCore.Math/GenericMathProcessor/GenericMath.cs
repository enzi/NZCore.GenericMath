    ...
    public static partial class GenericMath
    {
            ...
            byte* cappedValuePtr)
        {
            switch (dataType)
            {
                ...
                {
                    mathOperator.ProcessWithMinMax<BigDouble, GenericMathProcessor.BigDoubleProcessor>(valuePtr, *(BigDouble*) changeValuePtr, 0, *(BigDouble*)cappedValuePtr);
            ...
            byte* cappedValuePtr)
        {
            switch (dataType)
            {
                ...
                case GenericDataType.BigDouble:
                {
                    mathOperator.ProcessWithMinMax<BigDouble, GenericMathProcessor.BigDoubleProcessor>(valuePtr, changeValue.BigDoubleValue, 0, *(BigDouble*)cappedValuePtr);
                ...
                case GenericDataType.Short:
                {
                    mathOperator.ProcessWithMinMax<short, GenericMathProcessor.ShortProcessor>(valuePtr, changeValue.ShortValue, 0, *(short*)cappedValuePtr);
                ...
                {
                    mathOperator.ProcessWithMinMax<ushort, GenericMathProcessor.UShortProcessor>(
                        valuePtr, changeValue.UShortValue, 0, *(ushort*)cappedValuePtr);
                ...
                {
                    mathOperator.ProcessWithMinMax<half, GenericMathProcessor.HalfProcessor>(
                        valuePtr, changeValue.HalfValue, half.zero, *(half*)cappedValuePtr);
                    break;
                }
                case GenericDataType.Float:
                {
                    mathOperator.ProcessWithMinMax<float, GenericMathProcessor.FloatProcessor>(
                        valuePtr, changeValue.FloatValue, 0, *(float*)cappedValuePtr);
                    break;
                }
                case GenericDataType.Int:
                {
                    mathOperator.ProcessWithMinMax<int, GenericMathProcessor.IntProcessor>(
                        valuePtr, changeValue.IntValue, 0, *(int*)cappedValuePtr);
                    break;
                }
                case GenericDataType.UInt:
                {
                    mathOperator.ProcessWithMinMax<uint, GenericMathProcessor.UIntProcessor>(
                        valuePtr, changeValue.UIntValue, 0, *(uint*)cappedValuePtr);
                    break;
                }
                case GenericDataType.Double:
                {
                    mathOperator.ProcessWithMinMax<double, GenericMathProcessor.DoubleProcessor>(
                        valuePtr, changeValue.DoubleValue, 0, *(double*)cappedValuePtr);
                    break;
                }
                case GenericDataType.Long:
                {
                    mathOperator.ProcessWithMinMax<long, GenericMathProcessor.LongProcessor>(
                        valuePtr, changeValue.LongValue, 0, *(long*)cappedValuePtr);
                    break;
                }
                case GenericDataType.ULong:
                {
                    mathOperator.ProcessWithMinMax<ulong, GenericMathProcessor.ULongProcessor>(
                        valuePtr, changeValue.ULongValue, 0, *(ulong*)cappedValuePtr);
                    break;
                }
                case GenericDataType.Byte:
                {
                    mathOperator.ProcessWithMinMax<byte, GenericMathProcessor.ByteProcessor>(
                        valuePtr, changeValue.ByteValue, 0, *cappedValuePtr);
                    break;
                }
                case GenericDataType.Bool:
                case GenericDataType.None:
...
#if BIGDOUBLE
                case GenericDataType.BigDouble:
                    leftValue.BigDoubleValue = mathOperator.ProcessReturnValue(leftValue.BigDoubleValue, rightValue.BigDoubleValue);
                    break;
#endif
                case GenericDataType.Short:
...
#if BIGDOUBLE
                case GenericDataType.BigDouble:
                    return new GenericUnionValue { BigDoubleValue = mathOperator.ProcessReturnValue(leftValue.BigDoubleValue, rightValue.BigDoubleValue) };
#endif
                case GenericDataType.Short:
...
#if BIGDOUBLE
                case GenericDataType.BigDouble:
                    return new GenericUnionValue { BigDoubleValue = mathFunction.ProcessMathFunction(value.BigDoubleValue) };
#endif
                case GenericDataType.Short:
        ...
        public static unsafe void Process(this MathOperator mathOperator, GenericDataType dataType, byte* valuePtr, GenericUnionValue value)
        {
            switch (dataType)
            {
                ...
                case GenericDataType.BigDouble:
                {
                    mathOperator.Process(dataType, valuePtr, value.BigDoubleValue);
                    break;
                }
#endif
                case GenericDataType.Short:
        ...
        public static unsafe bool LogicalComparison(this ConditionLogicValueComparison logicValueComparison, GenericDataType dataType, byte* valueA, GenericUnionValue valueB)
        {
            switch (dataType)
            {
                ...
                case GenericDataType.BigDouble:
                {
                    var val = *(BigDouble*)valueA;
                    return logicValueComparison.LogicalComparison(val, valueB.BigDoubleValue);
                }
#endif
                case GenericDataType.Byte:
                {
        ...
        public static unsafe bool MultiplyBaseValue(GenericDataType dataType, byte* valuePtr, byte* baseValuePtr, int multiplier)
        {
            switch (dataType)
            {
                ...
                case GenericDataType.BigDouble:
                {
                    ref var value = ref *(BigDouble*)valuePtr;
                    ref var baseValue = ref *(BigDouble*)baseValuePtr;
                ...
                case GenericDataType.UInt:
                {
                    ref var value = ref *(uint*)valuePtr;
                    ref var baseValue = ref *(uint*)baseValuePtr;
                    var newValue = (uint)(baseValue * multiplier);
        ...
        public static unsafe void Set(GenericDataType dataType, byte* valueA, string value)
        {
            switch (dataType)
            {
                case GenericDataType.None:
                ...
                case GenericDataType.Bool:
                {
                    *(byte*)valueA = value != "0" ? (byte)1 : (byte)0;
                    break;
                }
                case GenericDataType.Byte:
                {
                    *(byte*)valueA = byte.Parse(value);
                    break;
                }
                case GenericDataType.Short:
                {
