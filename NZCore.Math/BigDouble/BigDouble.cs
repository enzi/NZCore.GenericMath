...
namespace NZCore
{
    public partial struct BigDouble : IFormattable, IComparable, IComparable<BigDouble>, IEquatable<BigDouble>
    {
        ...
        public override string ToString() => BigNumber.FormatBigDouble(this, null);

        public string ToString(string format) => BigNumber.FormatBigDouble(this, format);
        public string ToString(string format, IFormatProvider formatProvider) => BigNumber.FormatBigDouble(this, format);
        ...
        public static BigDouble Add(BigDouble left, BigDouble right)
        {
            ...
            //Example: 299 + 18
            return Normalize(math.round(1e14 * bigger.Mantissa + 1e14 * smaller.Mantissa * PowersOf10.Lookup(smaller.Exponent - bigger.Exponent)),
                bigger.Exponent - 14);
        }
        ...
        public static bool operator <(BigDouble a, int b)
        {
            if (IsNaN(a) || IsNaN(b))
            {
                return false;
